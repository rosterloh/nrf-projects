...
#if CONFIG_CONTROLLER_HID_MOUSE
...
#if CONFIG_CONTROLLER_HID_KEYBOARD
	0x05, 0x01,     /* Usage Page (Generic Desktop) */
...
#if (CONFIG_CONTROLLER_CONFIG_CHANNEL_ENABLE && !CONFIG_CONTROLLER_HID_MOUSE)
	USER_CONFIG_FEATURE_REPORT(REPORT_ID_USER_CONFIG, REPORT_SIZE_USER_CONFIG),
#endif
	0xC0,		/* End Collection (Application) */
#endif

#if CONFIG_CONTROLLER_HID_CONSUMER_CTRL
