...
#define SCAN_TRIG_TIMEOUT_MS  K_SECONDS(CONFIG_CONTROLLER_BLE_SCAN_START_TIMEOUT_S)
#define SCAN_DURATION_MS      K_SECONDS(CONFIG_CONTROLLER_BLE_SCAN_DURATION_S)
