...
LOG_MODULE_REGISTER(MODULE, CONFIG_CONTROLLER_BLE_ADV_LOG_LEVEL);

#ifndef CONFIG_CONTROLLER_BLE_FAST_ADV_TIMEOUT
#define CONFIG_CONTROLLER_BLE_FAST_ADV_TIMEOUT 0
#endif

#ifndef CONFIG_CONTROLLER_BLE_SWIFT_PAIR_GRACE_PERIOD
#define CONFIG_CONTROLLER_BLE_SWIFT_PAIR_GRACE_PERIOD 0
#endif


#define DEVICE_NAME	CONFIG_CONTROLLER_BLE_SHORT_NAME
...
#if CONFIG_CONTROLLER_BLE_SWIFT_PAIR
...
{
	bool fast_adv = IS_ENABLED(CONFIG_CONTROLLER_BLE_FAST_ADV) && can_fast_adv;
...
static bool event_handler(const struct event_header *eh)
{
	...
	if (IS_ENABLED(CONFIG_CONTROLLER_POWER_MANAGER_ENABLE)) {
