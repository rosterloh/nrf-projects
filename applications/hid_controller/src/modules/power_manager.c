...
LOG_MODULE_REGISTER(MODULE, CONFIG_CONTROLLER_POWER_MANAGER_LOG_LEVEL);


#define POWER_DOWN_ERROR_TIMEOUT K_SECONDS(CONFIG_CONTROLLER_POWER_MANAGER_ERROR_TIMEOUT)
#define POWER_DOWN_TIMEOUT_MS	 K_SECONDS(CONFIG_CONTROLLER_POWER_MANAGER_TIMEOUT)
...
static bool event_handler(const struct event_header *eh)
{
	...
	if (IS_ENABLED(CONFIG_CONTROLLER_USB_ENABLE) && is_usb_state_event(eh)) {
