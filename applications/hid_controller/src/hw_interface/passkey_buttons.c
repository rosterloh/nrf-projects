...
LOG_MODULE_REGISTER(MODULE, CONFIG_CONTROLLER_PASSKEY_LOG_LEVEL);

#define CLEAR_INPUT_ON_HOLD_TIMEOUT K_SECONDS(2)
...
struct input_buf {
	u8_t buf[CONFIG_CONTROLLER_PASSKEY_MAX_LEN];
	u8_t cnt;
};
