...
EVENT_TYPE_DEFINE(hid_keyboard_event,
		  IS_ENABLED(CONFIG_CONTROLLER_INIT_LOG_HID_KEYBOARD_EVENT),
...
EVENT_TYPE_DEFINE(hid_mouse_event,
		  IS_ENABLED(CONFIG_CONTROLLER_INIT_LOG_HID_MOUSE_EVENT),
		  log_hid_mouse_event,
...
EVENT_TYPE_DEFINE(hid_consumer_ctrl_event,
		  IS_ENABLED(CONFIG_CONTROLLER_INIT_LOG_HID_CONSUMER_CTRL_EVENT),
...
EVENT_TYPE_DEFINE(hid_report_subscriber_event,
		  IS_ENABLED(CONFIG_CONTROLLER_INIT_LOG_HID_SUBSCRIBER_EVENT),
...
EVENT_TYPE_DEFINE(hid_report_sent_event,
		  IS_ENABLED(CONFIG_CONTROLLER_INIT_LOG_HID_REPORT_SENT_EVENT),
...
EVENT_TYPE_DEFINE(hid_report_subscription_event,
		  IS_ENABLED(CONFIG_CONTROLLER_INIT_LOG_HID_SUBSCRIPTION_EVENT),
