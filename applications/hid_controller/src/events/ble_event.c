...
EVENT_TYPE_DEFINE(ble_peer_event,
		  IS_ENABLED(CONFIG_CONTROLLER_INIT_LOG_BLE_PEER_EVENT),
		  log_ble_peer_event,
		  &ble_peer_event_info);
...
EVENT_TYPE_DEFINE(ble_peer_search_event,
		  IS_ENABLED(CONFIG_CONTROLLER_INIT_LOG_BLE_PEER_SEARCH_EVENT),
...
EVENT_TYPE_DEFINE(ble_peer_operation_event,
		  IS_ENABLED(CONFIG_CONTROLLER_INIT_LOG_BLE_PEER_OPERATION_EVENT),
		  log_ble_peer_operation_event,
		  &ble_peer_operation_event_info);

EVENT_TYPE_DEFINE(ble_discovery_complete_event,
		  IS_ENABLED(CONFIG_CONTROLLER_INIT_LOG_BLE_DISC_COMPLETE_EVENT),
		  NULL,
		  NULL);
