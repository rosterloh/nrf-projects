...
LOG_MODULE_REGISTER(MODULE, CONFIG_MESH_SENSOR_SETTINGS_LOADER_LOG_LEVEL);

#define THREAD_STACK_SIZE	CONFIG_MESH_SENSOR_SETTINGS_LOADER_THREAD_STACK_SIZE
...
{
	if (IS_ENABLED(CONFIG_MESH_SENSOR_SETTINGS_LOADER_USE_THREAD)) {
